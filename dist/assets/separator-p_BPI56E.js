import{c as p,m as $,g as u,j as h,d as v}from"./index-9onUbQM6.js";import{r as i}from"./router-GXfyPTrP.js";/**
...
Defaulting to \`${c}\`.`}function d(e){return m.includes(e)}const f=s,g=i.forwardRef(({className:e,orientation:r="horizontal",decorative:o=!0,...t},a)=>h.jsx(f,{ref:a,decorative:o,orientation:r,className:v("shrink-0 bg-zinc-200 dark:bg-zinc-800",r==="horizontal"?"h-[1px] w-full":"h-full w-[1px]",e),...t}));g.displayName=f.displayName;export{I as C,g as S};
