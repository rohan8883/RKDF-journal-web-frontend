  ...
  const navItems = [
    { title: "HOME", link: "/" },
    {
      ...
      dropdownItems: [
        ...
        { title: "PRIVACY STATEMENT", link: "/ijhesm/privacy" },
        { title: "ETHICS POLICY", link: "/ijhesm/ethicspolicy" },
        { title: "ALL POLICY", link: "/ijhesm/allPolicy" },
        { title: "INDEXING", link: "/ijhesm/indexing" },
      ],
    },
    { title: "EDITORIAL BOARD", link: "/ijhesm/editorialTeam" },
    {
      title: "FOR AUTHOR",
      link: "",
      hasDropdown: true,
      dropdownItems: [
        { title: "SUBMIT PAPER", link: "/ijhesm/submissions" },
        { title: "PUBLICATION PROCEDURE", link: "/ijhesm/publicationProcedure" },
        { title: "ARTICLE PROCESSING CHARGE", link: "/ijhesm/pubChange" },
        { title: "SAMPLE PAPER FORMAT", link: "/" },
        { title: "COPYRIGHT FORM", link: "/" },
        { title: "RESEARCH AREA", link: "/ijhesm/researchArea" },
      ],
    },
    { title: "CURRENT", link: "/" },
    { title: "ARCHIVES", link: "/ijhesm/archive" },
